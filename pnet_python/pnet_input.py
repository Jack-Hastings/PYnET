...
I have changed the naming convention to comply with pep8: 
Switch from CamelCase to snake_case. 
I've also simplified where possible. e.g. gross -> grs
Standardized where possible. e.g. Mass, m -> ms; 
Brought tot to front, add it where in description, but missing
There is an inconsistency with tot & yearly use. Need to check all names 
