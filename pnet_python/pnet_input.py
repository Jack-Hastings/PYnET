...
share = {
    ...
    # BudC=(veg.FolMassMax- FolMass)*veg.CFracBiomass: 0,  In PnET-Day only
    'bud_c': 0,                 # bud carbon
    'water': 0,		            # soil water
    ...
    'light_eff_c_bal': 0,       # light effect at fol. light comp. point.
    'tot_light_eff_c_bal': 0,   # tot. light eff. at fol. light comp. in GS
